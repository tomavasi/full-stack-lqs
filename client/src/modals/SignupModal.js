...
import { useRegister} from '../api/useBackEnd';
    ...
    <div onClick={() => setSignUpModal(false)} className='signupmodal'>
      <section onClick={e => e.stopPropagation()} className='signup-form'>
        ...
        <form className='inputcontainer'>
          ...
          {registerMsg != '' && <p className='instructions'>{registerMsg}</p>}
          <button className='signupbtnmain' onClick={handleSubmit} disabled={!validMatch || !validName || !validPwd ? true : false}>Sign Up</button>
